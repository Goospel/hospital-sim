 ...
 *
 * 카테고리별 휘도 상한과 그 검사는 `backdropPalette.test.ts`가 잠근다.
 */
export const BACKDROP_PALETTE = {
  ...
  // ── 지면 ──
  grassBase: "#070a08",
  grassNoiseLight: "#080c08",
  grassNoiseDark: "#050706",
  tuft: "#0b100e",
  tuftShade: "#080c0a",
  shrub: "#0a0f0c",
  medianStrip: "#080a07",
  ...
  pavementBase: "#08080a",
  pavementNoiseLight: "#0a0b0b",
  pavementNoiseDark: "#060608",
  pavementSeam: "#050507",
  parkingLot: "#090910",
  dirtBase: "#0c0a06",
  dirtNoiseLight: "#0d0a05",
  dirtNoiseDark: "#080603",
  fieldFurrowLight: "#0c0a05",
  fieldFurrowDark: "#090804",
  paddyBase: "#060a08",
  paddyCellLight: "#070c0a",
  paddyCellDark: "#050907",
  forestFloor: "#070c09",
  ...
  roofEdge: "#0b0b12",
  roofVent: "#0a0a10",
  roofVentShade: "#060609",
  roofPenthouse: "#0d0b06",
  aptBody: "#0a0a11",
  aptEdge: "#0b0b13",
  aptTower: "#090913",
  aptTowerLit: "#0b0b16",
  houseRoofWarm: "#0e0b08",
  houseRoofWarmShade: "#090704",
  houseRidgeWarm: "#0f0b07",
  houseRoofCool: "#0c0b10",
  houseRoofCoolShade: "#070710",
  houseRidgeCool: "#0c0b15",
  materialStack: "#0d0c08",
  materialStackShade: "#0a0906",
  breakwater: "#0b0b0f",
  lampPost: "#0d0c08",
  vehicleBlue: "#090b0e",
  vehicleRed: "#0d0a0a",
  ...
  // ── 랜드마크 — 지역 식별의 핵심이라 부지보다 약간 밝은 것까지만 허용한다 ──
  treeCanopy: "#0b110d",
  treeCanopyLit: "#0e1510",
  treeShade: "#070c09",
  forestCanopy: "#0a110d",
  forestCanopyLit: "#0d1510",
  forestCanopyDark: "#080d0a",
  riverBase: "#0a0f15",
  riverFlow: "#0c1420",
  seaBase: "#080e15",
  seaRipple: "#0b1420",
