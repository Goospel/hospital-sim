...
2. **7일 진료** — 매일 밀려드는 환자를 한정된 자리로 받거나 돌려보낸다. 그중엔 분만·뇌출혈·중증외상·심근경색 **응급 콜**이 섞여 온다 — 응급 콜이 오면 15초 안에 받기/돌려보내기를 **당신이 직접** 누른다. 구조가 막으면(병상·당직·배후) 받기는 잠기고 사유 도장이 찍힌다(병상 없음 / 응급실 당직 없음 / 과밀 / 배후진료 불가) — 돌려보내는 버튼만 남는다. 발신자가 아무리 **매달려도** 판정은 안 바뀐다 — 구조의 벽을 받는 쪽에서 겪는 부분. 시간을 흘리면 환자는 응답 없이 다른 병원으로 넘어간다. 하루 끝마다 손익이 쌓이고, 이튿날 아침 신문에 어제 돌려보낸 사람들이 실린다.
