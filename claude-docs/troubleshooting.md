...
- [T-155](troubleshooting/T-155.md) · 영상 하네스의 12주 빨리감기가 40분 상한에서 11주 6일로 끊겼다 — __ffwd는 프레임당 게임분을 넘기므로 소요 시간은 게임 안 날수가 아니라 실제 렌더 프레임 수다. UI가 무거워지면(팔레트 상주 로스터) 옛 타임아웃이 조용히 부족해진다
